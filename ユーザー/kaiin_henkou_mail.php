...
<body>
<?php if($_SESSION["mail_henkou"]): ?>
		<h3>変更後のメールアドレスを入力してください</h3>
		<div class="henkou">
		<form action="kaiin_henkou_update.php" method="post">
		メールアドレス<br>
		<input type="text" name="mail_henkou" size="50">
		<input type="submit" value="送信"><br>
		</form>
		<a href="kaiin_henkou.php">各種変更項目</a>
		<a href="TOP.php">TOP</a>
		<?php unset($_SESSION['mail_henkou']); ?>
		</div>
<?php else: ?>
		...
		ID名<br>
		<input type="text" name="id_name_mail_henkou" size="20"><br>
		パスワード<br>
